...
class HeartRailsExpressClient {
    ...
    func send<Request: HeartRailsExpressRequest>(
        request: Request,
        completion: @escaping (APIResult<Request.Response, HeartRailsExpressClientError>) -> Void
    ) {
