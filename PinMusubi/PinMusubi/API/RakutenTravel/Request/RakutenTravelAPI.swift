...
enum RakutenTravelAPI {
    ...
    struct HotelDetailSearch: RakutenTravelRequest {
        let hotelNo: String?
        let hotelThumbnailSize: String?
        ...
        var path: String {
            return "/services/api/Travel/HotelDetailSearch/20170426"
        }
        ...
        var queryItems: [URLQueryItem] {
            return [
                ...
                URLQueryItem(name: "format", value: format),
                URLQueryItem(name: "formatVersion", value: formatVersion),
                URLQueryItem(name: "hotelNo", value: hotelNo),
                URLQueryItem(name: "datumType", value: datumType),
                URLQueryItem(name: "hotelThumbnailSize", value: hotelThumbnailSize),
