...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.8.0"])
      ...
      s.add_runtime_dependency(%q<ruby-macho>.freeze, [">= 1.3.1", "~> 1.3"])
      ...
      s.add_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.8.0"])
      ...
      s.add_dependency(%q<ruby-macho>.freeze, [">= 1.3.1", "~> 1.3"])
