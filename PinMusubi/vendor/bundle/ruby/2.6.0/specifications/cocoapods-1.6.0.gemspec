...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.6.0"])
      s.add_runtime_dependency(%q<claide>.freeze, [">= 1.0.2", "< 2.0"])
      s.add_runtime_dependency(%q<cocoapods-deintegrate>.freeze, [">= 1.0.2", "< 2.0"])
      ...
      s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.8.0", "< 2.0"])
      ...
      s.add_runtime_dependency(%q<ruby-macho>.freeze, ["~> 1.3", ">= 1.3.1"])
      s.add_development_dependency(%q<bacon>.freeze, ["~> 1.1"])
      s.add_development_dependency(%q<bundler>.freeze, ["~> 1.3"])
      s.add_development_dependency(%q<rake>.freeze, ["~> 10.0"])
    else
      s.add_dependency(%q<cocoapods-core>.freeze, ["= 1.6.0"])
      s.add_dependency(%q<claide>.freeze, [">= 1.0.2", "< 2.0"])
      s.add_dependency(%q<cocoapods-deintegrate>.freeze, [">= 1.0.2", "< 2.0"])
      ...
      s.add_dependency(%q<xcodeproj>.freeze, [">= 1.8.0", "< 2.0"])
      ...
      s.add_dependency(%q<ruby-macho>.freeze, ["~> 1.3", ">= 1.3.1"])
