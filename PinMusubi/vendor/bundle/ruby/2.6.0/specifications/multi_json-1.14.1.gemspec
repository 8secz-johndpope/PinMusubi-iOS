# -*- encoding: utf-8 -*-
# stub: multi_json 1.14.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/intridea/multi_json/issues", "changelog_uri" => "https://github.com/intridea/multi_json/blob/v1.14.1/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/multi_json/1.14.1", "source_code_uri" => "https://github.com/intridea/multi_json/tree/v1.14.1", "wiki_uri" => "https://github.com/intridea/multi_json/wiki" } if s.respond_to? :metadata=
